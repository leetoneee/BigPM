...
import ProjectAssigneeModal from '../create/project-assignee';
...
const Overview = ({ id, setIsModalNewTaskOpen }: Props) => {
  ...
  // Load data
  useEffect(() => {
    const project = projectDetail(Number(id));
    setProject(project);
  }, []);
  ...
  useEffect(() => {
    if (project) {
      ...
      const startDate = parseDate(formatDate(project.startDate));
      setStartDate(startDate);
      const endDate = parseDate(formatDate(project.endDate));
      setEndDate(endDate);
      setDescription(project.description);
      setObjecttives(project.objectives);
    }
  }, [project]);
