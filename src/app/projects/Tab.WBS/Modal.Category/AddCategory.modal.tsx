            ...
            <div className="relative flex flex-row">
              ...
              <div className="flex basis-[70%] gap-8">
                <div className="relative w-1/2">
                  ...
                  />
                  <div className="bg-gray-300 absolute right-14 top-1/2 h-full w-px -translate-y-1/2 transform"></div>
                  <span className="text-gray-500 absolute right-3 top-1/2 -translate-y-1/2 transform">
                    mins
                  </span>
                </div>
                {/* Price */}
