...
type Props = {
  ...
  setTeamMembers: Dispatch<SetStateAction<ProjectAssignee[]>>;
};

const maxInProgressProject: number = 4;

const ProjectAssigneeModal = ({
  isOpen,
  onOpen,
  onOpenChange,
  teamMembers,
  ...
  const handleContinue = () => {
    const selectedAssignees: ProjectAssignee[] = assignees
      .filter((assignee) => {
...
export default ProjectAssigneeModal;
